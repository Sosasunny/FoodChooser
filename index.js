...
var foodChoices = ["Pizza", "Burger", "Pasta", "Sushi", "Wraps", "Seafood", "Massala", "Chicken and Chips"];

/*
Saving data in case the user refreshes or leaves the page*/
...
//Allow food choice to be deleted
